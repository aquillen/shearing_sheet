...
/////////////////////stuff I want to set/input
	...
	double boxsize 			= 2000.0;	// pc, is half the box length
        ...
        double vel_std                  =  5.3;   // initial velocity dispersion 
                                                  // of massive particles
                                                  // in km/s
        double vel_stdz                 = 10.0;  // z velocity dispersion 
	surfacedensity 	        	= 10.0;	// surface density of massive particles 
        ...
        alpham_om                       = 2e-2; // for setting alpham, damping rate for massive particles
...
// these are first!!!!!!!!!!
        add_massless( r, nparticles_nomass, rmassless);
